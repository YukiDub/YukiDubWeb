...
<div class="auth-form">
    ...
    <form class="row g-3 needs-validation" action="{{route('auth.register')}}" method="post" novalidate>
        @csrf
        ...
        <div class="text-center">
            <p>У вас уже есть аккаунут? Тогда вы можете <a href="{{route('login')}}">авторизоваться</a></p>
        </div>
    </form>
</div>
