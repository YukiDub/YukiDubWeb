"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_FooterComponent_vue"],{
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("footer", { staticClass: "d-none d-md-block" }, [
      _c("div", { staticClass: "col-3 float-start" }, [
        _c("p", { staticClass: "ps-4" }, [
          _vm._v("YukiDub - аниме, манга, ранобэ. У нас найдется всё!"),
        ]),
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "float-end footer-links pe-4" }, [
        _c("ul", [
          _c("li", [
            _c("a", { attrs: { href: "#" } }, [_vm._v("Карта сайта")]),
          ]),
          _vm._v(" "),
          _c("li", [_c("a", { attrs: { href: "#" } }, [_vm._v("Наш API")])]),
          _vm._v(" "),
          _c("li", [
            _c("a", { attrs: { href: "#" } }, [_vm._v("Состояние серверов")]),
          ]),
          _vm._v(" "),
          _c("li", [
            _c("a", { attrs: { href: "#" } }, [_vm._v("Авторские права")]),
          ]),
          _vm._v(" "),
          _c("li", [
            _c("a", { attrs: { href: "#" } }, [
          ...
          _vm._v(" "),
          _c("li", [
            _c("a", { attrs: { href: "#" } }, [_vm._v("Поддержать проект")]),
          ]),
        ]),
      ]),
    ])
