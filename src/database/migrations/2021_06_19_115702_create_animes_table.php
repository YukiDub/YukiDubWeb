...
class CreateAnimesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('animes', function (Blueprint $table) {
            ...
            $table->foreign("genres")->on("genres")->references("genreId");
            ...
            $table->foreign("staff")->on("anime_staff")->references("animeStaffId");

            $table->unsignedBigInteger("characters");
            $table->foreign("characters")->on("anime_characters")->references("animeCharactersId");
